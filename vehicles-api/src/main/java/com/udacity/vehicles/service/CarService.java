...
public class CarService {
    ...
    private final WebClient.Builder webClientPricing;
    ...
    public CarService(WebClient.Builder webClientPricing, @Qualifier("maps") WebClient webClientMaps, ModelMapper modelMapper, CarRepository repository) {
